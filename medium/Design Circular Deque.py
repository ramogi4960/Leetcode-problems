...
class MyCircularDeque:
    ...
    def __init__(self, k: int):
        # let it be a simple list of maximum length k
        self.capacity = k
        self.deque = []

    def insertFront(self, value: int) -> bool:
        # insert into front of self.deque and return True. If full, return False
        if len(self.deque) == self.capacity: return False
        self.deque.insert(0, value)
        return True

    def insertLast(self, value: int) -> bool:
        # append self.deque and return True. If full, return False
        if len(self.deque) == self.capacity: return False
        self.deque.append(value)
        return True

    def deleteFront(self) -> bool:
        # deletes the first item and returns True. Returns False if self.deque is empty
        if not self.deque: return False
        del self.deque[0]
        return True

    def deleteLast(self) -> bool:
        # deletes the last item and return True. Returns False if self.deque is empty
        if not self.deque: return False
        del self.deque[-1]
        return True
