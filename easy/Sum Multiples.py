...
Input: n = 7
Output: 21
Explanation: Numbers in the range [1, 7] that are divisible by 3, 5, or 7 are 3, 5, 6, 7. The sum of these
numbers is 21.
Example 2:
...
class Solution:
    def sumOfMultiples(self, n: int) -> int:
        return sum([item for item in list(range(1, n+1)) if item%3 == 0 or item%5 == 0 or item%7 == 0])